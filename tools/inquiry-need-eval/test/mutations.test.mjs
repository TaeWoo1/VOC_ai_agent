...
const MUTATIONS = [
  ...
  // --- Inquiry v3.5: the CustomerGoal contract and the Layer-A headline --------------------------------------
  {
    ...
    to: '  ;',
    witness: async (M) => M.parseGoal({ id: 'g1', explicit_request: 'r', requested_outcome: 'ANSWER',
  ...
  {
    name: 'a question is allowed to reach a procedure',
    file: 'customer-goals.mjs',
    ...
    real: ['ACTION'], mutated: ['ANSWER', 'STATE_READ', 'ACTION'],
  },
  {
    name: 'an answer is routed straight to the seller instead of asking knowledge first',
    file: 'customer-goals.mjs',
    from: "ANSWER: 'KNOWLEDGE', STATE_READ: 'ENTITY_STATE', ACTION: 'PROCEDURE',",
    to: "ANSWER: 'SELLER', STATE_READ: 'ENTITY_STATE', ACTION: 'PROCEDURE',",
    witness: async (M) => M.FIRST_RESOLVER.ANSWER,
  ...
  },
  {
    ...
    witness: async (M) => M.scoreLayerA(
      ...
      { C6: [{ id: 'g1', request: 'r', outcome: 'ANSWER', subject: 'CURRENT_ORDER', basis: 'STATED', constraints: [] },
  ...
  },
  {
    ...
    witness: async (M) => M.scoreLayerA(
      [{ q: 'C6', goal: 'n1', gid: 'n1', requested_outcome: 'ANSWER', referent: 'CURRENT_ORDER', basis: 'STATED',
        explicit_constraints: 0 }],
      { C6: [{ id: 'g1', request: 'r', outcome: 'ANSWER', subject: 'CURRENT_ORDER', basis: 'STATED', constraints: [] },
        { id: 'g2', request: 'r', outcome: 'ACTION', subject: 'CURRENT_ORDER', basis: 'STATED', constraints: [] }] },
