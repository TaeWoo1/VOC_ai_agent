...
echo "    • What is stored, per review: the review text, the 별점, the 등록일, the 노출상품ID (옵션ID), and how"
...
echo "    • A review with a 별점 but no text is skipped and counted, not stored. Two such reviews of the same"
echo "      product on the same day at the same score cannot be told apart, and storing them would merge two"
echo "      real reviews into one."
