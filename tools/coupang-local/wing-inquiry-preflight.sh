...
echo "    • It looks ONLY in link addresses, element ids, and data-* attributes. Nowhere else."
echo "    • Around a single match it then measures SHAPE: what tag it is, how many identically shaped"
echo "      siblings the thing above it has, whether that offers a way into a detail view."
echo "    • **What your customers wrote never leaves this window.** The page's text is compared, inside the"
echo "      page, against fixed Coupang words like 답변완료 — and only the COUNT comes out. No customer text,"
echo "      no link address, no class name is returned, logged, or written down anywhere."
