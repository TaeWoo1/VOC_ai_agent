...
echo "                 box is which"
echo "  auto-advance : SEVEN steps advance on what the runtime OBSERVES on WING, with no button press. The"
...
echo "                 That reading is now taken WHILE YOU FILL THE FORM IN, about once a second, and when it"
echo "                 reads complete the step finishes ITSELF — it is the seventh auto-advance and the reason"
echo "                 that count went up on 2026-08-13. Still an emptiness count per field and nothing else"
echo "  the panel    : it is docked out of the way of the ring AND of the controls you have to use to reach it"
echo "                 — on the vendor screen, the form fields and the '확인' below them. It covered that"
echo "                 button on 2026-08-12 while pointing at the option above it"
