...
/**
 * **What the reviewnary 도우미 dock may show, and when.** (Agent UX cleanup, 2026-08-19.)
 *
 ...
 *   need it (NAVER 리뷰 수집, Coupang 상품평 찾기, guided issuance) carry their own "reviewnary 도우미가 필요합니다"
...
/** Seller-facing words. "reviewnary 도우미", never "로컬 에이전트". */
export const DOCK_COPY = {
  connected: "reviewnary 도우미 연결됨",
  connectedDetail: "이 브라우저가 내 PC의 reviewnary 도우미와 연결되어 있어요.",
  ...
  pairingAttested: "내 PC 화면에 뜬 reviewnary 창에서 [허용]을 눌러 주세요.",
  pairingWaiting: "확인을 기다리는 중…",
  pairingReopen: "허용 창이 안 열렸나요? 다시 열기",
  notice: {
    agent_off: { title: "reviewnary 도우미와 연결이 끊어졌어요", body: "내 PC에서 도우미가 꺼진 것 같아요. 도우미를 실행하면 자동으로 다시 연결돼요." },
    dropped: { title: "reviewnary 도우미와 연결이 끊어졌어요", body: "잠시 후 자동으로 다시 연결해요. 계속 안 되면 내 PC의 도우미가 실행 중인지 확인해 주세요." },
    revoked: { title: "reviewnary 도우미 연결이 해제됐어요", body: "내 PC의 도우미에서 이 브라우저의 연결이 해제됐어요. 다시 연결해 주세요." },
    denied: { title: "reviewnary 도우미 연결이 거부됐어요", body: "다시 연결하고, 내 PC에 열리는 창에서 허용을 눌러 주세요." },
    incompatible: { title: "reviewnary 도우미 업데이트가 필요해요", body: "reviewnary 또는 내 PC의 도우미를 최신 버전으로 업데이트해 주세요." },
