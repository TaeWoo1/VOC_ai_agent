...
export const HERO = {
  ...
  body: "문의도 리뷰도 채널마다 흩어져 있습니다. reviewnary는 흩어진 고객의 말을 한곳에 모아 정리하고, 반복되는 문제를 기억해 두었다가, 판매자가 놓치면 안 되는 신호만 남깁니다.",
...
export const GUIDE = {
  heading: "reviewnary는 판매를 대신하지 않습니다. 고객운영을 맡습니다.",
  body: "주문과 배송은 이미 쓰고 계신 도구가 합니다. reviewnary는 그 위에 얹히는 고객운영 레이어입니다 — 문의와 리뷰를 모아 정리하고, 반복되는 문제를 기억하고, 오늘 확인할 것을 골라 둡니다.",
  principle: "결정은 판매자가 합니다. reviewnary는 결정과 결정 사이의 일을 옮깁니다.",
  notHeading: "reviewnary가 아닌 것",
  notItems: [
    "주문·배송·정산을 처리하는 도구",
...
export const HOW = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: "초안을 준비하는 데까지가 reviewnary의 몫입니다. 고객에게 보내는 것은 판매자가 확인하고 누릅니다.",
    },
  ],
} as const;
...
export const CONNECT = {
  ...
  lead: "모든 채널이 같은 방식으로 붙지는 않습니다. reviewnary는 채널별로 가능한 방식만 표시하고, 안 되는 것은 안 된다고 씁니다.",
  modes: [
    {
      title: "연결로 가져오기",
    ...
    {
      title: "화면 안내로 가져오기",
      body: "플랫폼이 사람의 확인을 요구하는 채널입니다. 필요한 한 번의 확인은 판매자가 직접 하고, 그 뒤는 reviewnary가 잇습니다.",
    },
    {
      title: "정기 자료 가져오기",
...
export const FIT = {
  ...
  notFit: [
    "주문·배송·정산을 처리할 도구를 찾고 계신 경우 — reviewnary는 그 자리를 대신하지 않습니다.",
...
export const FAQ = {
  ...
  items: [
    ...
    {
      q: "답변을 대신 보내주나요?",
      a: "보내지 않습니다. 초안을 준비하는 데까지가 reviewnary의 몫이고, 고객에게 나가는 것은 판매자가 확인하고 직접 누릅니다.",
    },
    {
      q: "설치가 필요한가요?",
...
export const PAGE_META = {
  title: "reviewnary — 온라인 판매자를 위한 AI 고객운영 도구",
  description:
