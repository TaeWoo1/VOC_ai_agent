...
public enum CaseReason {
    ...
    REVIEW_WATCH_PROBLEM("별점 3점 리뷰에 불편을 말하는 내용이 있어 살펴봅니다."),
    REVIEW_HIGH_RATING_PROBLEM("별점은 높지만 불편을 말하는 내용이 있어 살펴봅니다."),
    REVIEW_HIGH_RATING_WITH_TEXT("별점은 높지만 글이 있어 바로 닫지 않고 지켜봅니다."),
    REVIEW_ROUTINE("글 없이 별점 4~5점만 남긴 리뷰라 따로 대응할 일이 없습니다."),
