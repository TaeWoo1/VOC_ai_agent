 ...
 *
 *   set -a && . ./.env && set +a
 *   npx tsx instruments/live-runs/run-store-identity-diagnostic-live-naver.ts -- --i-understand-this-inspects-live-naver-read-only
 *
...
import { urlCategory } from "../../src/naver/session-check";
