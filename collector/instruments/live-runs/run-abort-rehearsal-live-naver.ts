 ...
 *
 *   set -a && . ./.env && set +a
 *   npx tsx instruments/live-runs/run-abort-rehearsal-live-naver.ts -- --i-understand-this-posts-a-live-naver-reply
 *
...
import { login, startReplySubmissionRun, submitReplyOutcome } from "../../src/upload";
