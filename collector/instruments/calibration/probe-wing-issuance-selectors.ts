...
import type { FixedLabelContainmentReading } from "../../src/action-window/api-issuance-calibration/visual-recon-inpage";
import type { FieldRegionCensus } from "../../src/action-window/coupang-wing-field-region";
import {
