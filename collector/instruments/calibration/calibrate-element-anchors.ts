 ...
 *   npx tsx instruments/calibration/calibrate-element-anchors.ts -- --i-understand-this-inspects-live-naver-read-only
 *
...
import { screenApiCenterUrl } from "../../src/cli/observe-api-center";
import {
  hasLiveRunApproval,
  hasNoIngest,
  hasReplyRunApproval,
...
export function calibrationApprovalRequiredMessage(): string {
  return [
    ...
    `  npx tsx instruments/calibration/calibrate-element-anchors.ts -- ${REVIEW_ID_PROBE_FLAG}`,
  ].join("\n");
}
