 ...
 *
 *   npx tsx instruments/calibration/calibrate-review-list.ts -- --i-understand-this-opens-live-coupang-wing
 *   # optional, for the catalog-scope question:
 *   SELLEROPS_REVIEW_PRODUCT_IDS=productId:15411270785 npx tsx instruments/calibration/calibrate-review-list.ts -- …
 *
...
import { CoupangWingReviewDriver } from "../../src/action-window/coupang-wing-review-driver";
import {
  chooseDedupeKey,
