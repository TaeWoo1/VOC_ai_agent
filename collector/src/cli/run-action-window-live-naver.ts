...
const CONFIRM_PROMPT = [
  ...
  "and waits for YOU to perform the real export action in that window. It only observes,",
  "verifies, detects the download read-only, validates it, and ingests it. The Runtime",
  "never performs the export action for you. (Ctrl-C to abort.)",
].join("\n");
