...
| NAVER | ORDER_SUMMARY | API | ✅ 키 등록 폼 | ✅ | ✅ 2026-06-14, **2026-08-22 재검증** (bounded 최근 14일 창, `backfill` lane, primary cursor 불변; 08-21·08-22 두 날짜에 27건) | ❌ (스케줄 off — 운영자 pause 유지) | `docs/sellerops_phase3c_live_smoke.md` §0 · `docs/evidence/INDEX.md` | "자동 수집 지원: 주문" |
