...
- **current branch:** `feat/r4-supervised-channel-runtime` (fast-forwarded to the merged `origin/main` state; this post-merge docs sync is the only pending change — no new feature work started)
